...
def RecursivelyCreateDir(*args):
  return _pywrap_tensorflow.RecursivelyCreateDir(*args)
...
def CreateBufferedInputStream(*args):
  return _pywrap_tensorflow.CreateBufferedInputStream(*args)
CreateBufferedInputStream = _pywrap_tensorflow.CreateBufferedInputStream

def CreateWritableFile(*args):
  return _pywrap_tensorflow.CreateWritableFile(*args)
CreateWritableFile = _pywrap_tensorflow.CreateWritableFile

def AppendToFile(*args):
  return _pywrap_tensorflow.AppendToFile(*args)
AppendToFile = _pywrap_tensorflow.AppendToFile

def FlushWritableFile(*args):
  return _pywrap_tensorflow.FlushWritableFile(*args)
...
class BufferedInputStream(_object):
    ...
    __del__ = lambda self : None;
    def ReadLineAsString(self): return _pywrap_tensorflow.BufferedInputStream_ReadLineAsString(self)
...
def JoinPathImpl(*args):
  return _pywrap_tensorflow.JoinPathImpl(*args)
...
def CleanPath(*args):
  return _pywrap_tensorflow.CleanPath(*args)
...
class FileStatistics(_object):
    ...
    if _newclass:is_directory = _swig_property(_pywrap_tensorflow.FileStatistics_is_directory_get, _pywrap_tensorflow.FileStatistics_is_directory_set)
    def __init__(self): 
...
def RunCppShapeInference(*args):
  return _pywrap_tensorflow.RunCppShapeInference(*args)
